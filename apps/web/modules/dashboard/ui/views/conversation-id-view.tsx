                    ...
                    <AIInput onSubmit={form.handleSubmit(onSubmit)}>
                                ...
                                <AIInputTextarea
                                    ...
                                    placeholder={
                                        conversation?.status === "resolved"
                                            ? "Cuộc trò chuyện này đã được giải quyết"
                                            : "Nhập phản hồi của bạn làm toán tử..."
                                    }
                                    value={field.value}
                                />
                            )}
                        ...
                        <AIInputToolbar>
                            <AIInputTools>
                                ...
                                >
                                    <Wand2Icon />
                                    {isEnhancing ? "Đang tạo..." : "Nâng cao"}
                                </AIInputButton>
                            </AIInputTools>
                            <AIInputSubmit
                                disabled={
                                    conversation?.status === "resolved" || !form.formState.isValid || form.formState.isSubmitting || isEnhancing
                                }
                                status="ready"
                                type="submit"
                            />
        ...
        <div className="flex h-full flex-col bg-muted">
            ...
            <div className="p-2">
                <AIInput>
                    <AIInputTextarea
                        disabled
                        placeholder="Nhập tin nhắn của bạn làm toán tử..."
                    />
                    <AIInputToolbar>
                        <AIInputTools />
